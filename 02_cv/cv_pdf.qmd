...
html = "table.html"
htmlwidgets::saveWidget(table, html)
webshot2::webshot(html, "table.png", cliprect = c(40, 35, 930, 320), zoom = 2)
...
### `r fa("person-praying")` Working Papers
```{r}
#| echo: false 
#### Load the data ####
file = gsub("/02_cv", "", getwd())
...
html = "table.html"
htmlwidgets::saveWidget(table, html)
webshot2::webshot(html, "table.png", cliprect = c(40, 35, 930, 300), zoom = 2)

```
### `r fa("person-digging")` Underway Research
```{r}
#| echo: false 
#### Load the data ####
file = gsub("/02_cv", "", getwd())
...
html = "table.html"
htmlwidgets::saveWidget(table, html)
webshot2::webshot(html, "table.png", cliprect = c(40, 35, 930, 650), zoom = 2)
...
html = "table.html"
htmlwidgets::saveWidget(table, html)
webshot2::webshot(html, "table.png", cliprect = c(20, 35, 930, 570), zoom = 2)
