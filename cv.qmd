...
pub = dplyr::filter(pub, WorkingVersion == "Yes") |> select(-WorkingVersion)
...
#### Present the table ####
reactable(
  pub, theme = fivethirtyeight(),  defaultPageSize = 3,
  defaultColDef = colDef(align = "left", maxWidth = 200), 
...
#### Construct the table ####
reactable(
  conf, theme = fivethirtyeight(),  defaultPageSize = 3,
  defaultColDef = colDef(align = "left"), 
