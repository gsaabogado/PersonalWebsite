...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    journal: "Energy and Climate Change 6, 100191",
    year: 2025,
  ...
  {
    title: "Residential Solar Adoption: Main Determinants and the Future of Small-Scale Photovoltaics",
    authors: "Severin Reissl, Luis Sarmiento, Johannes Emmerling",
    journal: "Environmental Research: Energy 2(3), 035002",
    year: 2025,
    doi: "10.1088/2753-3751/ade79a",
    status: "published",
    area: "energy-modeling",
    question: "What drives household adoption of rooftop solar, and how will small-scale photovoltaic capacity evolve across income groups?",
    questionEs: "¿Qué determina la adopción de paneles solares residenciales y cómo evolucionará la capacidad fotovoltaica de pequeña escala entre grupos de ingreso?",
    findings: [
      "The baseline scenario projects roughly 47% of German households adopting rooftop solar by 2050, with adoption growth peaking around 2030.",
      "Adoption is highly unequal across income: the top decile reaches 77% by 2050, against just 6% for the bottom decile.",
      "This gradient makes feed-in tariff benefits regressive, with wealthier households capturing disproportionately larger subsidies.",
    ],
    findingsEs: [
      "El escenario base proyecta que cerca del 47% de los hogares alemanes adoptarán energía solar en tejados para 2050, con el mayor crecimiento alrededor de 2030.",
      "La adopción es muy desigual según el ingreso: el decil más alto alcanza 77% para 2050, frente a solo 6% en el decil más bajo.",
      "Este gradiente hace que los beneficios de las tarifas de inyección sean regresivos, pues los hogares más ricos captan subsidios desproporcionadamente mayores.",
    ],
  },
  {
    title: "The Air Quality Effects of Uber",
    authors: "Luis Sarmiento, Yeong-Jae Kim",
    journal: "Journal of Urban Economics 153, 103846",
    year: 2026,
  ...
  },
  {
    ...
    journal: "Energy and Climate Change 5, 100165",
    year: 2024,
  ...
  },
  {
    ...
    journal: "Energy and Climate Change 5, 100154",
    year: 2024,
  ...
  },
  {
    ...
    journal: "Energy and Climate Change 5, 100144",
    year: 2024,
  ...
  },
  {
    ...
    journal: "Journal of Public Economics 227, 105014",
    year: 2023,
  ...
  {
    title: "Congestion, Air Quality, and Space",
    authors: "Filippo Tassinari, Luis Sarmiento",
    journal: "Handbook of Labor, Human Resources and Population Economics, 1–18",
    year: 2023,
    status: "published",
    area: "econometrics",
  },
  {
    ...
    authors: "John Bistline, et al.",
    journal: "Energy and Climate Change 5, 100118",
    year: 2024,
  ...
  },
  {
    ...
    journal: "Economics of Energy & Environmental Policy 13, no. 1, 57–82",
    year: 2024,
  ...
  },
  {
    ...
    authors: "Luis Sarmiento, et al.",
    journal: "Energy Policy, 156, 112378",
    year: 2021,
  ...
  },
  {
    ...
    journal: "Transportation Research Part D 82, 102274",
    year: 2020,
  ...
  // === Under Review ===
  {
    ...
    journal: "Journal of Environmental Economics and Management (Under Review)",
    year: 2024,
    status: "under-review",
    area: "econometrics",
    workingPaper: {
  ...
  },
  {
    ...
    journal: "Empirical Economics (Accepted)",
    year: 2024,
    status: "revise-resubmit",
    area: "econometrics",
    workingPaper: {
  ...
  },
  {
    ...
    findings: [
      "Both hot and cold short-run temperature shocks increase remittance inflows to Mexican municipalities.",
      "The median municipality receives about 1.6% more in remittances than it would at the thermal optimum.",
      "Extreme temperatures reduce the probability of working on a given day, consistent with remittances smoothing consumption after negative income shocks.",
    ],
    findingsEs: [
      "Los choques de temperatura de corto plazo, tanto de calor como de frío, aumentan las remesas recibidas por los municipios mexicanos.",
      "El municipio mediano recibe alrededor de 1.6% más en remesas de lo que recibiría en el óptimo térmico.",
  ...
  },
  {
    ...
    journal: "Journal of Environmental Economics and Management (Revise and Resubmit)",
    year: 2024,
    status: "revise-resubmit",
    area: "econometrics",
  ...
  },
  {
    ...
    journal: "American Journal of Agricultural Economics (Under Review)",
    year: 2024,
    status: "under-review",
    area: "econometrics",
  ...
  {
    title: "Rural Development and Environmental Trade-offs in Mexico's Flagship Agroforestry Programme",
    authors: "Sarah Meier, Luis Sarmiento",
    journal: "",
    year: 2026,
    status: "working-paper",
    area: "econometrics",
    question: "Does Mexico's flagship agroforestry programme deliver rural development without environmental trade-offs?",
    questionEs: "¿El programa insignia de agroforestería de México logra el desarrollo rural sin generar costos ambientales?",
    findings: [
      "Sembrando Vida increases deforestation at the agricultural frontier, adding 24.5 hectares of annual forest loss per treated municipality within 500 metres of existing farmland.",
      "Effects are strongest immediately after enrolment and spill over into adjacent and more distant forest, consistent with spatial leakage.",
      "Deforestation effects largely disappear for later cohorts enrolled under stricter environmental rules, showing that programme design and enforcement matter.",
    ],
    findingsEs: [
      "Sembrando Vida incrementa la deforestación en la frontera agrícola, añadiendo 24.5 hectáreas de pérdida forestal anual por municipio tratado dentro de 500 metros de tierras agrícolas existentes.",
      "Los efectos son más fuertes inmediatamente después del ingreso al programa y se propagan a bosques adyacentes y más distantes, consistente con fugas espaciales.",
      "Los efectos sobre la deforestación desaparecen en gran medida para las cohortes posteriores inscritas bajo reglas ambientales más estrictas, mostrando que el diseño y la aplicación del programa son determinantes.",
    ],
  },
  {
    title: "The Global Economic Burden of Air Pollution",
    authors: "Piero Basaglia, Moritz A. Drupp, Lutz Sager, Luis Sarmiento, Felix Schaumann",
    journal: "",
    year: 2026,
    status: "working-paper",
    area: "econometrics",
