...
#### Construct the table ####
reactable( prof, theme = fivethirtyeight(font_size = 12),
...
#### Create the table ####
reactable(educ, theme = fivethirtyeight(font_size = 12),
...
reactable(
  ...
  defaultColDef = colDef(align = "center", maxWidth = 300), 
  columns = list(
...
#### Construct the table ####
reactable(
  conf, theme = fivethirtyeight(font_size = 12),  defaultPageSize = 5,
